...
function Start () { 
  ...
  // create Parallelepipoid if don't exists
	if(gameObject.Find("PlanePivot").transform.Find ("Forme").transform.Find("FormePaddle1") == null) {
		Parallelepipoid = new GameObject ("FormePaddle1");
		Parallelepipoid.transform.parent = gameObject.Find("PlanePivot").transform.Find("Forme").transform;
	}
	else {
		Parallelepipoid = gameObject.Find("PlanePivot").transform.Find("Forme").transform.Find("FormePaddle1").gameObject;
	}
...
function OtherFace () {
    var mesh = gameObject.Find("PlanePivot").transform.Find("Forme").transform.Find("FormePaddle1").GetComponent(MeshFilter).sharedMesh;
